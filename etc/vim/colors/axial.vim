" axial.vim -- gray/orange colorscheme for the terminal

highlight clear
syntax reset
set notermguicolors
let g:colors_name = "axial"
...
hi Visual ctermfg=0 ctermbg=223 cterm=none
...
" ui
hi CurSearch ctermfg=15 ctermbg=8 cterm=none
